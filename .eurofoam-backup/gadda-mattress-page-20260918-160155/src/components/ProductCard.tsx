...
export default function ProductCard({
  ...
  return (
    <article className="group relative overflow-hidden rounded-[2rem] border border-ink/10 bg-white shadow-[0_12px_40px_rgba(22,29,35,0.06)]">
      <WishlistButton
        mattress={{
          slug: mattress.slug,
          name: mattress.name,
      ...
      >
        <div
          className={`relative bg-linear-to-br ${mattress.accent} p-3`}
        >
          <img
            src={mattress.image}
            alt={mattress.name}
