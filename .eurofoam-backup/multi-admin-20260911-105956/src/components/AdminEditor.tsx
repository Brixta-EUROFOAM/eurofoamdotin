...
export default function AdminEditor({
  ...
  function updateHeroSlide(
    ...
    setData((current) => {
      ...
      const slides = [...(next.site.heroSlides || [])];
              ...
              <div className="mt-8 grid gap-5 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="mt-2 text-xs leading-5 text-ink/40">
                    Legacy fallback image. The live homepage uses the
                    banner slideshow below when slides are enabled.
                  </p>
                </div>

                <div className="md:col-span-2 mt-6 rounded-[1.7rem] border border-ink/10 bg-[#FAF8F4] p-5 md:p-7">
                  <div className="flex flex-wrap items-start justify-between gap-5">
                    <div>
                      <FieldLabel>Homepage banner slideshow</FieldLabel>

                      <h2 className="font-display text-3xl">
                        Hero campaigns
                      </h2>

                      <p className="mt-2 max-w-3xl text-xs leading-5 text-ink/50">
                        Each enabled slide fills the homepage hero and the
                        entire banner links to its destination. For best
                        results upload a 3200×1800 or 3840×2160 image with
                        generous negative space for the copy.
                      </p>
                    </div>
                    ...
                    {(data.site.heroSlides || []).map(
                      (slide, index) => (
                        ...
                        >
                          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-ink/10 px-5 py-4">
                            ...
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                className="rounded-full border border-ink/10 px-3 py-2 text-xs font-black disabled:opacity-25"
                              >
                                ↑
                              </button>
                          ...
                          <div className="grid gap-6 p-5 lg:grid-cols-[1.05fr_.95fr]">
                            <div>
                              <FieldLabel>
                                4K banner image
                              </FieldLabel>
                              ...
                              <label className="mt-4 block">
                                ...
                                <TextInput
                                  ...
                                  placeholder="Euro Align mattress in warm studio setting"
                                  onChange={(event) =>
                                    updateHeroSlide(index, {
                              ...
                              <label className="mt-4 block">
                                ...
                                <p className="mt-2 text-xs leading-5 text-ink/40">
                                  Examples: 50% 50% = centre,
                                  70% 50% = favour the right side.
                                </p>
                              </label>
                            </div>
